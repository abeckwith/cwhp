b_bios = [
    ...
    },
    {
        ...
        narrative: `
            ...
            cared for by her sister Ozeline (Pearson) Wise until her death in June
            1977.
    ...
    },
    {
        ...
        otherNotes: "",
        references: `<a
                href="https://www.radcliffe.harvard.edu/schlesinger-library/collections/black-women-oral-history-project" >https://www.radcliffe.harvard.edu/schlesinger-library/collections/black-women-oral-history-project</a>
        `,
    ...
    },
    {
        ...
        narrative: `
            ...
            with renowned composers including Gabriel Faur&eacute;, whose work she promoted
    ...
    },
    {
        ...
        narrative: `
            ...
            local, national, and international employees.<br>
    ...
    },
    {
        ...
        deathLocation: "",
        narrative: `
            Bread and Roses was co-founded by Pat Hynes and Gill Gane. It opened its doors as a
            woman-owned business for &ldquo;women and their friends&rdquo; after five months of renovating a
            &ldquo;dank,
            dismal&rdquo; neighborhood bar. Except for the plumbing, women did all of the architectural design,
            electrical,
            carpentry, sheet rocking, plastering, and painting, with a backdrop of feminist and lesbian
            singers/songwriters
           ...
           In 1978 the restaurant sold to young feminists who in turn
            ...
            restaurant Oleana, owned by Executive Chef Ana Sortun, has occupied the space since 2001.
    ...
    },
    {
      ...
      Christian Movement in New England, which had an office in the basement of First Church in Cambridge-Congregational,
       from 1978 to 1994. 
        ...
        In Nicgorski's obituary, it was reported that as she was preparing to head to Guatemala for missionary work, 
        she 
        <blockquote>
        "...heard the shocking news that four Catholic women missionaries from the United States, working in 
        El Salvador, were raped and murdered. Undeterred, she still undertook the journey. In July 1981, a few months 
        after her arrival in Guatemala, the village priest and his driver were assassinated by gunmen from the Guatemalan military. 
        A villager warned Ms. Nicgorski and the other nuns that their names were on a list and their lives were also in danger. 
        Ms. Nicgorski and the others made the treacherous journey out of Guatemala. While waiting for her future assignment, 
        she continued to serve the refugees and the poor in the camps that sprung up in Honduras and on the Mexican border."
        </blockquote>

        Nicgorski was one of 15 church workers that were tried by the federal government in 1985 in Arizona as part of the 
        infamous "Sanctuary Trials." The US Government, under Ronald Reagan's Justice Department inducted, tried, and
         convicted many church workers, nuns, and ministers for helping Central American refugees who were fleeing violence in their own 
         countries. Nicgorski was found guilty of conspiracy to violate United States immigration 
         laws and was sentenced to five years of probation. Despite her sentence, Nicgorski continued to advocate for these issues, speaking
          at churches, schools, and public events in over 200 cities.
        <br><br>

        After the trial, Nicgorski moved to Massachusetts, where she met Chris Blackburn in the Rev. Dr. Carter Heyward's 
        Feminist Liberation Theology class at the Episcopal Divinity School in Cambridge. The couple would be together 
        (marrying in 2008) for 29 years. They bought a home together on Harvey Street in North Cambridge in January, 1991, 
        and were highly involved in local political and social issues, as well as staying engaged in work on behalf of 
        refugees. The couple also worked to support local women candidates for City Council and other offices.
        <br><br>

        In 1995, the Cambridge Commission on the Status of Women (also known as The Cambridge Women's Commission) worked with the Cambridge Arts Commission, the Cambridge Historical 
        Commission, and City Councilor Katherine Triantafillou, along with local residents Blackburn, Nicgorski, and Marcia 
        Diehl to create the Cambridge Women's Trail. The trail was designed to celebrate the little-recognized accomplishments of Cambridge
         women and their contributions to their community over the history of the city. Blackburn recalls: 
        <blockquote>

        "My office for the University Christian Movement in New England was in the church at 11 Garden Street in Cambridge, 
        so I walked to Harvard Square, almost daily, where I'd see statues of males in the Cambridge Common. All these men 
        were mostly being honored for their participation in some war. I'd go home and tell Dar that all these men are being 
        honored and remembered in Cambridge but no women were honored in any visible way. So, out of that frustration and 
        awareness, Dar and I decided we'd organize something to honor a woman, in Cambridge." 
        </blockquote>
        This effort led to the creation of 
        the May Sarton memorial (Sarton was a well-known Cambridge poet, novelist, and writer) near the Cambridge Public Library, was
         the first step towards the larger
        Cambridge Women's Trail project and, eventually, the establishment of the Cambridge Women's Heritage Project.
        <br><br>

        In 1996, the Cambridge Peace Commission's "Peace and Justice Award" was jointly given to Nicgorski and Blackburn. In the 
        award description, the committee stated: 
        <blockquote>
        "Darlene has been working with refugees, chairing the Human Rights Commission,
         organizing on behalf of women, and doing everything possible to keep the City Council and the city itself progressive, 
         openminded and justice-minded...She is doggedly committed to labor, reproductive choice, and has worked in Cambridge 
         for both, organizing in support of UNITE workers, and educating the City Council on working conditions. Wherever justice 
         is being made in the Cambridge area, you'll find one and usually both of these women. They work at the grassroots 
         steadily, effectively and with grace and humor."
       </blockquote>

        Nicgorski became the chair of the city's Human Rights Commission and the couple marched with the Cambridge LGBT group 
        during many Boston Gay Pride Marches. In 2001 the couple moved to North Carolina. In 2008, they were married in San 
        Francisco, California, later relocating to southern California. Nicgorski received many awards in her lifetime, 
        ...
        <a class='indent' href="https://lib.arizona.edu/special-collections/collections/sanctuary-movement-trial-papers">https://lib.arizona.edu/special-collections/collections/sanctuary-movement-trial-papers</a>
        <br>
        <i>The Cambridge Chronicle</i>, 10 October 1996, 15 January 1998<br>
        <i>Claremont Courier</i> Obituary:<br>
        <a class='indent' href="https://claremont-courier.com/obituaries/t22635-nicgorski-33107/">https://claremont-courier.com/obituaries/t22635-nicgorski-33107/</a>
        <Br>
        Correspondence with Chris Blackburn

        `,
        photos: ["images_bios/chrisanddar2.jpg", "images_bios/chrisanddar.jpg"],
        photoTitles: [
            "Chris (L) and Dar (R), North Cambridge, c.1992", "Chris (L) and Dar (R), at a 2017 demonstration in California"
        ],
        dateCreated: "05.08.2026",
        dateUpdated: "",
